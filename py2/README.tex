%%% -*- Mode: LaTeX; -*-
%       RCS: $Id: README.tex,v 1.1 2018-11-07 18:46:50 lsipusr Exp $
...
roPerf Namespace: Remote Operation Performers (roPerf)  name base for a collection of libraries and command modules for webServices.



\section{Support}

For support, ideas, suggestions, criticism, comments and questions; please contact the 
author/maintainer \\
